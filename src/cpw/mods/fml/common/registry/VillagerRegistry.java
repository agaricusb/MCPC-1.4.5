...
public class VillagerRegistry
{
    ...
    public interface IVillageCreationHandler
    {
         ...
         * @param i
         */
        WorldGenVillagePieceWeight getVillagePieceWeight(Random random, int i);
         ...
         * @param p5
         */
        Object buildComponent(WorldGenVillagePieceWeight villagePiece, WorldGenVillageStartPiece startPiece, List pieces, Random random, int p1,
    ...
    {
        List<WorldGenVillagePieceWeight> parts = components;
    ...
    public static Object getVillageComponent(WorldGenVillagePieceWeight villagePiece, WorldGenVillageStartPiece startPiece, List pieces, Random random,
    ...
    public static void addEmeraldBuyRecipe(EntityVillager villager, MerchantRecipeList list, Random random, Item item, float chance, int min, int max)
    {
        if (min > 0 && max > 0)
        {
            EntityVillager.bN.put(item.id, new Tuple(min, max));
        }
        villager.a(list, item.getMaxDurability(), random, chance);
    }
    ...
    public static void addEmeraldSellRecipe(EntityVillager villager, MerchantRecipeList list, Random random, Item item, float chance, int min, int max)
    {
        if (min > 0 && max > 0)
        {
            EntityVillager.bO.put(item.id, new Tuple(min, max));
        }
        villager.b(list, item.getMaxDurability(), random, chance);
    }
