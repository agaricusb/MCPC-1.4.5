...
public class ModLoaderHelper
{
    ...
    public static void openGui(int id, EntityHuman player, Container container, int x, int y, int z)
    {
    ...
    public static Object getClientSideGui(BaseModProxy mod, EntityHuman player, int ID, int x, int y, int z)
    {
        if (sidedHelper != null)
        {
            ...
            boolean sendVelocityInfo)
    {
        ...
        er.setCustomSpawning(new ModLoaderEntitySpawnCallback(mod, er), EntityEnderDragon.class.isAssignableFrom(entityClass) || IAnimal.class.isAssignableFrom(entityClass));
    }
