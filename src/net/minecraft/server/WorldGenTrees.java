                ...
                for (int l1 = i - b0; l1 <= i + b0 && flag; ++l1) {
                    for (j1 = k - b0; j1 <= k + b0 && flag; ++j1) {
                        if (i1 >= 0 && i1 < 256) {
                            ...
                            Block var13 = Block.byId[k1];

                            if (k1 != 0 && !var13.isLeaves(w, l1, i1, j1) && k1 != Block.GRASS.id && k1 != Block.DIRT.id && !var13.isWood(w, l1, i1, j1)) {
                                flag = false;
                            }
                        } else {
                            flag = false;
            ...
            if (!flag) {
                ...
                if ((i1 == Block.GRASS.id || i1 == Block.DIRT.id) && j < 256 - l - 1) {
                    ...
                    for (j1 = j - b0 + l; j1 <= j + l; ++j1) {
                        ...
                        for (j2 = i - i2; j2 <= i + i2; ++j2) {
                            ...
                            for (int l2 = k - i2; l2 <= k + i2; ++l2) {
                                ...
                                Block var18 = Block.byId[world.getTypeId(j2, j1, l2)];

                                if ((Math.abs(k2) != i2 || Math.abs(i3) != i2 || random.nextInt(2) != 0 && k1 != 0) && (var18 == null || var18.canBeReplacedByLeaves(w, j2, j1, l2))) {
                    ...
                    for (j1 = 0; j1 < l; ++j1) {
                        ...
                        if (k1 == 0 || var21 == null || var21.isLeaves(w, i, j + j1, k))
                        {
                        ...
                        for (j1 = j - 3 + l; j1 <= j + l; ++j1) {
                            ...
                            for (j2 = i - i2; j2 <= i + i2; ++j2) {
                                for (k2 = k - i2; k2 <= k + i2; ++k2) {
                                    ...
                                    var21 = Block.byId[world.getTypeId(j2, j1, k2)];

                                    if (var21 != null && var21.isLeaves(w, j2, j1, k2))
                                    {
