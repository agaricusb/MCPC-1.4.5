...
public final class SpawnerCreature {
    ...
    public static boolean a(EnumCreatureType var0, World var1, int var2, int var3, int var4)
    {
        ...
        {
            return var1.getMaterial(var2, var3, var4).isLiquid() && !var1.t(var2, var3 + 1, var4);
        }
        else if (!var1.v(var2, var3 - 1, var4))
        {
            return false;
        }
        else
        {
            ...
            return var6 && var5 != Block.BEDROCK.id && !var1.t(var2, var3, var4) && !var1.getMaterial(var2, var3, var4).isLiquid() && !var1.t(var2, var3 + 1, var4);
        }
    }
