...
public abstract class EntityLiving extends Entity {
	...
	/**
	 * in each step in the damage calculations, this is set to the 'carryover'
	 * that would result if someone was damaged .25 hearts (for example), and
	 * added to the damage in the next step
	 */
	public int aS;
	public int aT;
	...
	private final ControllerJump jumpController;
	private final EntityAIBodyControl senses;
	private final Navigation navigation;
	public final PathfinderGoalSelector goalSelector;
	protected final PathfinderGoalSelector targetSelector;
	private EntityLiving bM;
	private final EntitySenses bN;
	private float bO;
	private final ChunkCoordinates bP = new ChunkCoordinates(0, 0, 0);
	private float bQ = -1.0F;
	private final ItemStack[] equipment = new ItemStack[5];
	protected float[] dropChances = new float[5];
	private final ItemStack[] bS = new ItemStack[5];
	...
	protected float bC;
	protected float bD;
	// blood - change isJumping to public
	...
	public void y()
	{
		...
		// CraftBukkit start
		if (this.isAlive() && this.inBlock() && !(this instanceof EntityEnderDragon))
		{ // EnderDragon's don't suffocate.
	...
	protected void aP()
	{
		...
		{ // CraftBukkit - (this.deathTicks == 20) -> (this.deathTicks >= 20 && !this.dead)
			int i;
	...
	{
		if (ForgeHooks.onLivingAttack(this, damagesource, i)) { return false; }
		...
		else
		{
			...
			else
			{
				...
				{
					if (i <= this.lastDamage) { return false; }
	...
	public void b(NBTTagCompound nbttagcompound)
	{
		...
		for (ItemStack element : this.equipment)
		{
			NBTTagCompound nbttagcompound1 = new NBTTagCompound();

			if (element != null)
			{
				element.save(nbttagcompound1);
			}
	...
	public boolean e(MobEffect mobeffect)
	{
		if (this.getMonsterType() == EnumMonsterType.UNDEAD)
		{
			...
			if (i == MobEffectList.REGENERATION.id || i == MobEffectList.POISON.id) { return false; }
		}
	...
	*/
	...
	public static Item a(int i, int j)
	{
		...
		case 4:
			...
			else if (j == 4) { return Item.DIAMOND_HELMET; }
		...
		case 3:
			...
			else if (j == 4) { return Item.DIAMOND_CHESTPLATE; }
		...
		case 2:
			...
			else if (j == 4) { return Item.DIAMOND_LEGGINGS; }
		...
		case 1:
			...
			else if (j == 4) { return Item.DIAMOND_BOOTS; }
