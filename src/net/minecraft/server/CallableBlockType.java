...
final class CallableBlockType implements Callable
{
    ...
    public String func_85079_a()
    {
        ...
        {
        	// CraftBukkit Block.a()
        	// Forge Block.getBlockName()
            return String.format("ID #%d (%s // %s)", new Object[] {Integer.valueOf(this.field_85080_a), Block.byId[this.field_85080_a].a(), Block.byId[this.field_85080_a].getClass().getCanonicalName()});
        }
