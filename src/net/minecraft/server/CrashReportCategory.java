...
public class CrashReportCategory
{
    ...
    {
        return String.format("%.2f,%.2f,%.2f - %s", new Object[] {Double.valueOf(par0), Double.valueOf(par2), Double.valueOf(par4), func_85071_a(MathHelper.floor((double)par0), MathHelper.floor((double)par2), MathHelper.floor((double)par4))});
    }
