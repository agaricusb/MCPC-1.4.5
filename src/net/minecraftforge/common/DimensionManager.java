...
public class DimensionManager
{
    ...
    {
        return getWorld(dim).worldProvider;
    }
    ...
    public static void setWorld(int id, WorldServer world)
    {
        if (world != null) {
            ...
            FMLLog.info("Loading dimension %d (%s) (%s)", id, world.getWorldData().getName(), world.getMinecraftServer());
        } else {
            worlds.remove(id);
