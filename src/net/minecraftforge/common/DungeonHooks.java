...
public class DungeonHooks
{
    ...
    {
        DungeonMob mob = (DungeonMob)WeightedRandom.a(rand, dungeonMobs);
        if (mob == null)
        {
            return "";
        }
    ...
    {
        DungeonLoot ret = (DungeonLoot)WeightedRandom.a(rand, dungeonLoot);
        if (ret != null)
        {
    ...
    public static class DungeonLoot extends WeightedRandomChoice
    {
    ...
    public static class DungeonMob extends WeightedRandomChoice
    {
        public String type;
