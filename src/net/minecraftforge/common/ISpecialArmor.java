...
public interface ISpecialArmor
{
     ...
     */
    public abstract int getArmorDisplay(EntityHuman player, ItemStack armor, int slot);
        ...
        public static int ApplyArmor(EntityLiving entity, ItemStack[] inventory, DamageSource source, double damage)
        {
            ...
            for (int x = 0; x < inventory.length; x++)
            {
                ...
                else if (stack.getItem() instanceof ItemArmor && !source.ignoresArmor())
                {
                    ...
                    prop = new ArmorProperties(0, armor.b / 25D, armor.getMaxDurability() + 1 - stack.getData());
                }
                if (prop != null)
                {
                    prop.Slot = x;
