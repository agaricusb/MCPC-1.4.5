...
public class OreDictionary
{
    ...
    public static void initVanillaEntries()
    {
        if (!hasInit)
        {
            ...
            registerOre("plankWood",   new ItemStack(Block.WOOD, 1, -1));
            registerOre("slabWood",    new ItemStack(Block.WOOD_STEP, 1, -1));
            registerOre("stairWood",   Block.WOOD_STAIRS);
            registerOre("stairWood",   Block.BIRCH_WOOD_STAIRS);
            registerOre("stairWood",   Block.JUNGLE_WOOD_STAIRS);
            registerOre("stairWood",   Block.SPRUCE_WOOD_STAIRS);
        ...
        replacements.put(new ItemStack(Block.WOOD, 1, -1), "plankWood");
        ...
        for(int i = 0; i < 16; i++)
        {
            ItemStack dye = new ItemStack(Item.INK_SACK, 1, i);
            if (!hasInit)
            {
        ...
        {
            new ItemStack(Block.LAPIS_BLOCK),
        ...
        for(Object obj : recipes)
        {
            if(obj instanceof ShapedRecipes)
            {
                ...
                if(containsMatch(true, recipe.items, replaceStacks))
                {
            ...
            else if(obj instanceof ShapelessRecipes)
            {
                ...
                if(containsMatch(true, (ItemStack[])recipe.ingredients.toArray(new ItemStack[0]), replaceStacks))
                {
